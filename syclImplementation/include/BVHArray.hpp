...
class BVHArray
{
    ...
    BVHArray(ObjectList* sceneObject, sycl::queue& myQueue);
...
BVHArray::BVHArray(ObjectList* sceneObject, sycl::queue& myQueue) : _myQueue(myQueue)
{
    ...
    _array = sycl::malloc_shared<BVHNode>(_arraySize, myQueue);
